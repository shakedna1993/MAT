...
/**
 * 
 * This class handles with all the functionality of the server. Each instants
 * gets msg from the clients and translates it for op-code and msg that contains
 * the relevant object/s. Later, for each op-code there is a relevant
 * functionality.
 */
